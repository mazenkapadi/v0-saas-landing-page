    ...
    <div className="bg-white text-black p-8 min-h-[29.7cm] w-full">
      <div className="mb-8">
        <div className="flex justify-between items-start">
          <div>
            <h1 className="text-2xl font-bold mb-1">{invoiceData.companyName && <p className="font-bold">{invoiceData.companyName}</p>}</h1>
            <p className="text-black/70">#{invoiceData.invoiceNumber}</p>
          </div>
          <div className="text-right">
            <p>Date: {formatDate(invoiceData.date)}</p>
            <p className="font-bold">Due Date: {formatDate(invoiceData.dueDate)}</p>
          </div>
        </div>
